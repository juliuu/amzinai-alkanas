...
import { Button, LoadingWrapper, LoadingBall } from './loadingButton.styles';

const LoadingButton = ({ value, valueConfirmed, type, disabled, formSent }) => {
  ...
  return (
    <AnimateSharedLayout>
      <Button layout disabled={disabled} type={type} transition={{ duration: transitionDuration }}>
        {formSent === 'pending' && (
